    ...
    <MotionConfig reducedMotion="user">
      ...
      <main>
        ...
        <section id="main-content" className="px-6 pt-32 pb-20 sm:pt-40 sm:pb-28">
          <motion.div
            className="mx-auto max-w-6xl grid lg:grid-cols-[1fr_1fr] gap-12 lg:gap-16 items-center"
            initial="hidden"
            animate="visible"
          ...
          >
            <div>
              <motion.h1
                className="font-serif text-[clamp(3rem,8vw,6rem)] leading-[1] tracking-tight"
                variants={fadeUp}
              ...
              >
                ...
                <a
                  ...
                  className="group relative inline-flex h-11 items-center gap-2 overflow-hidden rounded-lg border border-border-strong px-5 text-sm font-medium text-text transition-colors duration-350 hover:text-bg hover:border-text focus-visible:ring-2 focus-visible:ring-accent focus-visible:ring-offset-2 focus-visible:ring-offset-bg"
                >
                  ...
                  <span className="absolute inset-0 z-10 translate-y-[50%] scale-0 rounded-full bg-text transition-transform duration-350 group-hover:scale-x-[150%] group-hover:scale-y-[220%]" />
                </a>
              </motion.div>
        ...
        {/* How it works — mobile only (desktop shown in hero) */}
        <section className="scroll-mt-16 px-6 py-20 lg:hidden">
          <motion.div
            className="mx-auto max-w-6xl"
            initial="hidden"
            whileInView="visible"
            ...
            transition={{ duration: 0.6, ease }}
          >
            <h2 className="font-serif text-[clamp(1.75rem,4vw,2.75rem)] leading-[1.1] tracking-tight mb-3">
              How it works
            </h2>
